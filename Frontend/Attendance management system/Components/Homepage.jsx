...
function Homepage() {
  ...
  const cardData = [
    {
      "heading": "Easy Attendance Marking",
      "desc": "Mark attendance effortlessly with both manual and automated options. Users can check in with a single click, QR code scanning, or biometric integration for a seamless experience."
    },
    {
      "heading": "Real-time Attendance Tracking",
      "desc": "Monitor attendance in real time with a live dashboard. Instantly view who is present, absent, or late, ensuring better workforce or student management."
    },
    {
      "heading": "Detailed Reporting and Analytics",
      "desc": "Generate insightful reports with attendance trends, working hours, and absenteeism patterns. Export data in multiple formats (PDF, Excel) for record-keeping and payroll processing."
    },
    {
      "heading": "Integration with Calendars or Other Tools",
      "desc": "Sync attendance data with Google Calendar, Outlook, or HRM software for a streamlined workflow. Get automated reminders and notifications for better time management."
    },
    {
      "heading": "Role-based Access (Admin, Employee)",
      "desc": "Ensure data security with role-based access. Admins can manage records, employees or teachers can track attendance, and students or employees can view their logs."
    },
    {
      "heading": "Leave Management System",
      "desc": "Allow employees or students to request leaves through an integrated form. Admins can approve or reject requests, and users can track their leave status in real time."
    }
  ]
  ...
  return (
    <>
        <Navbar/>
        <section className='h-[70vh] flex justify-between items-center'>
          <div className='w-[50%] h-full  px-10'>
            <p className='font-bold text-[4vw]  tracking-tight leading-[8vh] mt-25 '>Effortless <br /> Attendance <br /> Management <br /> for Everyone</p>
            <p className='mt-5 font-medium text-lg'>Track, monitor, and manage attendance seamlessly.</p>
          </div>
          <div className='w-[50%] h-full flex justify-center items-center'>
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="457.347" height="391.898" viewBox="0 0 457.347 391.898">
  <defs>
  ...
  <g id="Attendance_Hero" data-name="Attendance Hero" transform="translate(-1085.08 -206.615)">
    ...
    <g id="Group_25345" data-name="Group 25345" transform="translate(1462.446 312.895)">
      <path id="Path_5073" data-name="Path 5073" d="M371.37,81.635c.325,0,.487.325.487.649a5.238,5.238,0,0,0,1.3,3.408A5.536,5.536,0,0,0,377.7,87.8a2.749,2.749,0,0,1,2.272,1.461,4.206,4.206,0,0,0,1.623,1.785,5.373,5.373,0,0,0,5.194.325,6.353,6.353,0,0,0,1.623-1.3,4.568,4.568,0,0,1,3.409-1.623,5.843,5.843,0,0,0,3.571-1.136,5.1,5.1,0,0,0,1.785-4.22,5.922,5.922,0,0,0-.974-3.246,2.825,2.825,0,0,1-.812-2.435,4.09,4.09,0,0,0-.974-3.246,4.6,4.6,0,0,0-1.785-1.3,3.06,3.06,0,0,1-1.785-3.408,6.9,6.9,0,0,0,.325-1.785c.812-5.518-4.545-10.875-4.545-10.875h0a3.491,3.491,0,0,1-4.22-.974l-2.11-2.435a.46.46,0,0,0-.812,0,.714.714,0,0,0-.162.812l1.3,1.623a5.368,5.368,0,0,1,0,6.168,8.333,8.333,0,0,0-1.623,3.9,33.978,33.978,0,0,0-.162,3.9,4.259,4.259,0,0,1-2.759,4.382,10.379,10.379,0,0,1-6.655-.487,10.981,10.981,0,0,1-4.22-2.922l-2.6-3.246a.574.574,0,0,0-.812.812l1.3,1.623a2.834,2.834,0,0,1,.649,1.948C364.066,75.305,366.5,80.661,371.37,81.635Z" transform="translate(-337.236 -47.995)" fill="#32285f"/>
      <path id="Path_5088" data-name="Path 5088" d="M372.541,69.827a1.886,1.886,0,0,1-2.11,2.11h0a1.8,1.8,0,0,1-1.623-1.948l.812-7.953c0-.325.162-.487.487-.812a1.24,1.24,0,0,1,.812-.325.767.767,0,0,1,.812.812Z" transform="translate(-332.726 -43.166)" fill="#fa968c"/>
      <path id="Path_5089" data-name="Path 5089" d="M388.707,55.7h0c1.136-1.461-1.785-6.005-6.817-4.707h0a8.675,8.675,0,0,1-5.356-.325,10.766,10.766,0,0,0-5.032-.649,6.707,6.707,0,0,0-5.518,3.571c-.487.325-.974.812-1.461,1.136-4.058,3.733-3.409,11.2-3.409,11.2h0a3.317,3.317,0,0,1,2.6,3.246v3.408a.7.7,0,0,0,.649.649.724.724,0,0,0,.649-.487l.162-2.11a5.369,5.369,0,0,1,3.9-4.869,9.2,9.2,0,0,0,3.733-1.948,21,21,0,0,0,2.6-2.922c.974-1.461,3.246-2.435,4.869-1.623a11.989,11.989,0,0,1,4.869,4.545,10.4,10.4,0,0,1,1.3,4.869V72.9a.649.649,0,1,0,1.3,0v-2.11a3.977,3.977,0,0,1,.649-1.948c2.11-2.759,3.733-8.44.649-12.173C388.545,56.346,388.545,56.022,388.707,55.7Z" transform="translate(-337.531 -49.974)" fill="#32285f"/>
      <path id="Path_5090" data-name="Path 5090" d="M400.8,108.23a17.749,17.749,0,0,0-2.435-5.032c-.974-1.136-5.356-.162-7.791.649a16.008,16.008,0,0,1-3.9.487c-9.576-.487-27.917-.162-32.137.649-5.681,1.136-8.6,5.681-7.791,8.765,1.136,5.032,4.22,6.168,9.9,5.032,4.058-.812,20.938-6.168,30.189-10.388a13.775,13.775,0,0,1,7.629-1.136Z" transform="translate(-346.54 -17.133)" fill="#fab9af"/>
      <path id="Path_72143" data-name="Path 72143" d="M250.146,267.7a4.378,4.378,0,1,1-1.278-3.1,4.377,4.377,0,0,1,1.278,3.1Z" transform="translate(-213.325 -247.623)" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="0.3"/>
      <path id="Path_72144" data-name="Path 72144" d="M259.126,267.7a4.378,4.378,0,1,1-1.278-3.1A4.377,4.377,0,0,1,259.126,267.7Z" transform="translate(-211.009 -247.623)" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="0.3"/>
      <path id="Path_72145" data-name="Path 72145" d="M248,268.306a1.786,1.786,0,0,1,3.573,0" transform="translate(-211.62 -246.795)" fill="none" stroke="#fff" stroke-linecap="round" stroke-miterlimit="10" stroke-width="0.3"/>
    </g>
  </g>
            </svg>
          </div>
        ...
        <section className=''>
          <p className='h-[10vh] text-4xl font-bold flex items-center justify-center'>Features</p>
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 p-10 w-[90%] m-auto'>
            {cardData.map((e,index)=>(
            <div key={index} className='w-full sm:w-[300px] md:w-[350px] shadow-lg p-4 hover:shadow-xl transition-all duration-300 hover:scale-105'>
              <p className='font-bold text-xl'>{e.heading}</p>
              <p className='mt-4'>{e.desc}</p>
            </div>
            ))}
          </div>
        </section>
